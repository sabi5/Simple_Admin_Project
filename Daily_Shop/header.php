              ...
              <div class="aa-cartbox"> 
                ...
                <div class="aa-cartbox-summary">
                  ...
                  <?php $grandTotal = 0;
                   ...
                   <ul>
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="<?php echo "img/".$_SESSION['cart'][$key]['image'];?>" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="#"><?php echo $_SESSION['cart'][$key]['name'];?></a></h4>
                        <p><?php echo "$".$_SESSION['cart'][$key]['price'];?></p>
                      </div>
                      <form action=<?php echo "deletecart.php?id=".$_SESSION['cart'][$key]['product_id'].
                      "&action=deleteproduct"?> method = 'POST'><input class="remove" type='submit' name='delete'
                      value='Delete'></form>
