<div id="sidebar">
	<div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
		<?php 
			...
			echo $filename; 
			$productmenu = array('addproducts.php', 'manageproducts.php', 'managecategories.php', 'managetags.php');
		...
		<ul id="main-nav">  <!-- Accordion Menu -->
			...
			<li>
				...
				<ul>
					<li><a <?php if($filename=='adduser.php') :?> class="current"<?php endif;?> href="adduser.php" id="tab2">Add User</a></li>
