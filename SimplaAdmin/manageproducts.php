	...
	<div class="content-box"><!-- Start Content Box -->
		...
		?> 
			...
			while ($data = mysqli_fetch_array($res)) {
				...
				echo "<td> <img src="."resources/images/".$data["image"]."></td>";
				echo "<td>" . $data["price"] . "</td>";
				echo "<td>" . $data["description"] . "</td>";
				echo "<td><a href='editproduct.php?id={$data['product_id']}' title='Edit'><img src='resources/images/icons/pencil.png' alt='Edit' /></a>
					<a href='deleteproduct.php?id={$data['product_id']}' title='Delete'><img src='resources/images/icons/cross.png' alt='Delete'/></a></td></tr></tbody>";
